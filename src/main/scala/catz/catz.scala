...
/**
  ...
  *including in any form recognizably derived from the original, except that a work that constitutes
  *a Collection will not be considered an Adaptation for the purpose of this License. For the
  *avoidance of doubt, where the Work is a musical work, performance or phonogram, the synchronization
  ...
  **
  *2. "Collection" means a collection of literary or artistic works, such as encyclopedias and anthologies,
  *or performances, phonograms or broadcasts, or other works or subject matter other than
  *works listed in Section 1(f) below, which, by reason of the selection and arrangement of their
  *contents, constitute intellectual creations, in which the Work is included in its entirety in unmodified
  ...
  **
  *3. "Creative Commons Compatible License" means a license that is listed at http://
  *creativecommons.org/compatiblelicenses that has been approved by Creative Commons as being
  *essentially equivalent to this License, including, at a minimum, because that license: (i)
  *contains terms that have the same purpose, meaning and effect as the License Elements of
  ...
  **
  *5. "License Elements" means the following high-level license attributes as selected by Licensor
  *and indicated in the title of this License: Attribution, ShareAlike.
  **
  *6. "Licensor" means the individual, individuals, entity or entities that offer(s) the Work under the
  *terms of this License.
  **
  *7. "Original Author" means, in the case of a literary or artistic work, the individual, individuals,
  ...
  **
  *8. "Work" means the literary and/or artistic work offered under the terms of this License including
  ...
  *with or without words; a cinematographic work to which are assimilated works expressed by
  *a process analogous to cinematography; a work of drawing, painting, architecture, sculpture,
  *engraving or lithography; a photographic work to which are assimilated works expressed by
  *a process analogous to photography; a work of applied art; an illustration, map, plan, sketch
  *or three-dimensional work relative to geography, topography, architecture or science; a performance;
  *a broadcast; a phonogram; a compilation of data to the extent it is protected as a
  ...
  **
  *9. "You" means an individual or entity exercising rights under this License who has not previously
  ...
  *10."Publicly Perform" means to perform public recitations of the Work and to communicate to the
  ...
  *public of the performances of the Work, including by public digital performance; to broadcast
  *and rebroadcast the Work by any means including signs, sounds or images.
  **
  *11."Reproduce" means to make copies of the Work by any means including without limitation
  ...
  **
  *2. to create and Reproduce Adaptations provided that any such Adaptation, including any translation
  *in any medium, takes reasonable steps to clearly label, demarcate or otherwise identify
  ...
  **
  *1. Non-waivable Compulsory License Schemes. In those jurisdictions in which the right to collect
  ...
  **
  *3. Voluntary License Schemes. The Licensor waives the right to collect royalties, whether individually
  *or, in the event that the Licensor is a member of a collecting society that administers
  *voluntary licensing schemes, via that society, from any exercise by You of the rights
  ...
  **
  *1. You may Distribute or Publicly Perform the Work only under the terms of this License. You
  ...
  *the Work as incorporated in a Collection, but this does not require the Collection apart from
  *the Work itself to be made subject to the terms of this License. If You create a Collection, upon
  *notice from any Licensor You must, to the extent practicable, remove from the Collection any
  *credit as required by Section 4(c), as requested. If You create an Adaptation, upon notice from
  *any Licensor You must, to the extent practicable, remove from the Adaptation any credit as
  *required by Section 4(c), as requested.
  **
  *2. You may Distribute or Publicly Perform an Adaptation only under the terms of: (i) this License;
  *(ii) a later version of this License with the same License Elements as this License; (iii) a Creative
  *Commons jurisdiction license (either this or a later license version) that contains the same
  *License Elements as this License (e.g., Attribution-ShareAlike 3.0 US)); (iv) a Creative Commons
  *Compatible License. If you license the Adaptation under one of the licenses mentioned in (iv),
  *you must comply with the terms of that license. If you license the Adaptation under the terms
  *of any of the licenses mentioned in (i), (ii) or (iii) (the "Applicable License"), you must comply
  *with the terms of the Applicable License generally and the following provisions: (I) You must
  *include a copy of, or the URI for, the Applicable License with every copy of each Adaptation You
  *Distribute or Publicly Perform; (II) You may not offer or impose any terms on the Adaptation
  *that restrict the terms of the Applicable License or the ability of the recipient of the Adaptation
  *to exercise the rights granted to that recipient under the terms of the Applicable License; (III)
  *You must keep intact all notices that refer to the Applicable License and to the disclaimer of
  *warranties with every copy of the Work as included in the Adaptation You Distribute or Publicly
  *Perform; (IV) when You Distribute or Publicly Perform the Adaptation, You may not impose any
  ...
  *Applicable License. This Section 4(b) applies to the Adaptation as incorporated in a Collection,
  *but this does not require the Collection apart from the Adaptation itself to be made subject
  *to the terms of the Applicable License.
  **
  *3. If You Distribute, or Publicly Perform the Work or any Adaptations or Collections, You must,
  *unless a request has been made pursuant to Section 4(a), keep intact all copyright notices for
  *the Work and provide, reasonable to the medium or means You are utilizing: (i) the name of the
  *Original Author (or pseudonym, if applicable) if supplied, and/or if the Original Author and/or
  *Licensor designate another party or parties (e.g., a sponsor institute, publishing entity, journal)
  *for attribution ("Attribution Parties") in Licensor's copyright notice, terms of service or by other
  *reasonable means, the name of such party or parties; (ii) the title of the Work if supplied; (iii) to
  *the extent reasonably practicable, the URI, if any, that Licensor specifies to be associated with
  *the Work, unless such URI does not refer to the copyright notice or licensing information for the
  *Work; and (iv) , consistent with Ssection 3(b), in the case of an Adaptation, a credit identifying
  *the use of the Work in the Adaptation (e.g., "French translation of the Work by Original Author,"
  *or "Screenplay based on original Work by Original Author"). The credit required by this Section
  *4(c) may be implemented in any reasonable manner; provided, however, that in the case of a
  *Adaptation or Collection, at a minimum such credit will appear, if a credit for all contributing
  ...
  *doubt, You may only use the credit required by this Section for the purpose of attribution in the
  *manner set out above and, by exercising Your rights under this License, You may not implicitly
  *or explicitly assert or imply any connection with, sponsorship or endorsement by the Original
  ...
  **
  *4. Except as otherwise agreed in writing by the Licensor or as may be otherwise permitted by
  ...
  *honor or reputation. Licensor agrees that in those jurisdictions (e.g. Japan), in which any exercise
  *of the right granted in Section 3(b) of this License (the right to make Adaptations) would
  *be deemed to be a distortion, mutilation, modification or other derogatory action prejudicial to
  *the Original Author's honor and reputation, the Licensor will waive or not assert, as appropriate,
  *this Section, to the fullest extent permitted by the applicable national law, to enable You to
  *reasonably exercise Your right under Section 3(b) of this License (right to make Adaptations)
  *but not otherwise.
  **
  ...
  *or Collections from You under this License, however, will not have their licenses terminated
  ...
  *8. Miscellaneous
  **
  *1. Each time You Distribute or Publicly Perform the Work or a Collection, the Licensor offers to
  ...
  **
  *6. The rights granted under, and the subject matter referenced, in this License were drafted utilizing
  *the terminology of the Berne Convention for the Protection of Literary and Artistic Works
  *(as amended on September 28, 1979), the Rome Convention of 1961, the WIPO Copyright Treaty
...
object catz {
  ...
  trait FlatMap[F[_]] extends Functor[F] {
    ...
    def flatMap[A, B](a: F[A])(f: A => F[B]): F[B] = bind(f)(a)
  }
  ...
  case class ReaderT[A, F[_], B](rd: A => F[B]) {
    def rws[W, S](implicit F: Functor[F], W: Monoid[W]): ReaderWriterStateT[A, W, S, F, B] =
      ReaderWriterStateT {
        case (r, s) => F.map(rd(r))(
          (W.id, _, s)
        )
  ...
  object ReaderT {
    type Reader[A, B] = ReaderT[A, Id, B]
  }

  case class WriterT[W, F[_], A](wx: F[(W, A)]) {
    def rws[R, S](implicit F: Functor[F]): ReaderWriterStateT[R, W, S, F, A] =
      ReaderWriterStateT {
        case (_, s) => F.map(wx) {
          case (w, a) => (w, a, s)
        }
